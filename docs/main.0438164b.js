...
},{"./arrayWithoutHoles":"qgAY","./iterableToArray":"dk6M","./unsupportedIterableToArray":"Q4vU","./nonIterableSpread":"ejHz"}],"WSmw":[function(require,module,exports) {
"use strict";var r=e(require("@babel/runtime-corejs2/helpers/toConsumableArray"));function e(r){return r&&r.__esModule?r:{default:r}}var o=EtherealColor,t=o.Color,n=o.Palette,u=o.Gradient;function l(){var r=t();return r.random(),r}function a(){var e=arguments.length>0&&void 0!==arguments[0]&&arguments[0],o=(0,r.default)(document.querySelectorAll(".hero__dinamic-logo div")),a=e?l():t("rgb(255,0,120)"),c=e?l():t("rgb(120,0,255)"),i=n([a,c]),d=u(i).toStringArray("rgb");o.forEach(function(r,e){return r.style.backgroundColor=d[e]})}a(),document.querySelector(".hero__dinamic-logo").onclick=function(){return a(!0)};
},{"@babel/runtime-corejs2/helpers/toConsumableArray":"TW4i"}]},{},["WSmw"], null)
//# sourceMappingURL=/ethereal-color/main.0438164b.js.map